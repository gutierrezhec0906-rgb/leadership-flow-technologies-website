...
export const appPage = {
  ...
  modulesSection: {
    ...
    screenshotAlt: "The Vision Builder module in the Accountability App, walking a leader through a 5-question guided vision exercise",
    screenshot2Src: "/images/app-screenshot-visual-management.webp",
    screenshot2Alt: "The Visual Management module in the Accountability App, showing a live red, yellow, and green escalation board for tracking open tasks to closure",
  },
...
export const moduleCategories = [
  ...
  },
  {
    ...
    modules: [
      ...
      { name: "Visual Management", icon: "LayoutGrid", description: "A live red, yellow, and green escalation board that tracks every open item until it's actually closed." },
    ],
  },
  {
    key: "interpersonal",
