...
export const videoResources = [
  { title: "La Fórmula del Equipo Ganador", description: "La combinación exacta de responsabilidad, confianza y propósito compartido que convierte a un grupo en un equipo." },
