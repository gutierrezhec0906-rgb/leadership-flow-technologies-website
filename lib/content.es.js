...
export const appPage = {
  ...
  howItWorksSection: {
    ...
    screenshotSrc: "/images/app-screenshot-dashboard-phone.webp",
    screenshotAlt: "El panel personal de un líder en la Accountability App, mostrando su Puntaje de Accountability, Metas SMART y Autoevaluación",
  },
  howItWorks: [
    {
      step: "01",
  ...
  modulesSection: {
    ...
    screenshotSrc: "/images/app-screenshot-vision-builder.webp",
    screenshotAlt: "El módulo Vision Builder en la Accountability App, guiando a un líder a través de un ejercicio de visión de 5 preguntas",
    screenshot2Src: "/images/app-screenshot-visual-management.webp",
    screenshot2Alt: "El módulo de Visual Management en la Accountability App, mostrando un tablero de escalación en vivo con semáforo rojo, amarillo y verde para dar seguimiento a tareas abiertas hasta su cierre",
  },
  ...
  monitoring: {
    ...
    screenshotSrc: "/images/app-screenshot-visual-management.webp",
    screenshotAlt: "El tablero de Visual Management de la Accountability App, mostrando conteos de estado verde, amarillo y rojo y un rastreador de escalación de tareas en vivo",
  },
  skillPillarsSection: {
    eyebrow: "La Base",
...
export const moduleCategories = [
  ...
  },
  {
    ...
    modules: [
      ...
      { name: "Visual Management", icon: "LayoutGrid", description: "Un tablero de escalación en vivo con semáforo rojo, amarillo y verde que da seguimiento a cada tarea abierta hasta que realmente se cierra." },
    ],
  },
  {
    key: "interpersonal",
