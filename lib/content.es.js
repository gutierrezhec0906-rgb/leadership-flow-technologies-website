...
export const aboutPage = {
  ...
  founderPhotoAlt: "Retrato de marcador de posición de Hector Gutierrez, fundador de Leadership Flow Technologies",
  storyQuote:
    "Envié a mi mejor gente a capacitarse. Los vi regresar el lunes por la mañana. Nada había cambiado.",
  storyParagraphs: [
    "Ese momento acompañó a Hector Gutierrez durante más de 30 años liderando equipos de alto desempeño en manufactura aeroespacial, de defensa y electrónica en Estados Unidos, México y Canadá.",
  ...
  experienceStats: [
    ...
    { value: "3", label: "Países — EE. UU., México, Canadá" },
...
export const podcastEpisodes = [
  { number: "01", title: "Establece el Estándar", description: "Por qué los estándares indefinidos son la raíz de la mayoría de los problemas de Accountability." },
  { number: "02", title: "Enciende la Visión", description: "Cómo convertir una lista de tareas en un propósito con el que tu equipo se compromete." },
  { number: "03", title: "Mejora el Flujo", description: "Cómo encontrar y eliminar los obstáculos que frenan el impulso de tu equipo." },
  { number: "04", title: "Capacita al Equipo", description: "La brecha entre esperar resultados y preparar a tu gente para lograrlos." },
  { number: "05", title: "Ganar con Compasión", description: "Cómo el cuidado y el desempeño se refuerzan mutuamente en la planta." },
];
