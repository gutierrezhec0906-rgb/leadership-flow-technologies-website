...
import { podcastEpisodes, resourcesPage } from "@/lib/content";

export default function PodcastSection() {
  return (
    <section className="bg-pale-green py-20 sm:py-28">
      <div className="container">
        <SectionHeader eyebrow="Listen" headline={resourcesPage.podcastHeadline} theme="light" />
          ...
          {podcastEpisodes.map((episode, index) => (
            <Reveal key={episode.number} delay={index * 0.06} className="flex items-center gap-5 p-6">
              ...
              <div className="flex-1">
                <p className="text-xs font-bold uppercase tracking-wide text-mid-green">Episode {episode.number}</p>
